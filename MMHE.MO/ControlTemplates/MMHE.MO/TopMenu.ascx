                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu"
                            ...
                            <a href="wdri.aspx" class="dropdown-item" key="t-dropdowns">Work Done Report - Subcon</a>
                            <a href="wcr.aspx" class="dropdown-item" key="t-buttons">Work Completion Report - Client</a>
                            <a href="wdr-list.aspx" class="dropdown-item" key="t-cards">Work Done Report - All</a>                            
