...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Menu.ascx.cs" Inherits="MMHE.MO.ControlTemplates.MMHE.MO.Menu" %>
	...
	<div class="navbar-header">
		...
		<div class="d-flex">
			...
			<div class="dropdown d-inline-block">
				...
				<div class="dropdown-menu dropdown-menu-end">
					<!-- item-->
					<a class="dropdown-item" href="#">Rafidah Binti Mohd Said</a>
		...
		<nav class="navbar navbar-light navbar-expand-lg topnav-menu">
			...
			<div class="collapse navbar-collapse" id="topnav-menu-content">
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown">
						<a href="./jcs.aspx" class="nav-link dropdown-toggle arrow-none" key="t-default">Job Confirmation Scope</a>
					</li>
					<li class="nav-item dropdown">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu"
							...
							<a href="#" class="dropdown-item" key="t-alerts">Daily Work Progress Log</a>
